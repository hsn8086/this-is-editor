...
export function useEditorScreenshot(options: UseEditorScreenshotOptions): UseEditorScreenshotReturn {
  ...
  async function writeToClipboard(canvas: HTMLCanvasElement): Promise<boolean> {
    ...
    try {
      ...
      console.error('[useEditorScreenshot] Failed to write to clipboard:', err)
      return false
    }
  }
   ...
   * 下载截图
   */
  function downloadScreenshot(canvas: HTMLCanvasElement, filename: string = 'code-screenshot.png'): void {
  ...
  function cleanup(wrapper: HTMLElement, style: HTMLLinkElement): void {
    try {
      ...
      console.warn('[useEditorScreenshot] Failed to remove wrapper:', err)
    }
    ...
    try {
      ...
      console.warn('[useEditorScreenshot] Failed to remove style:', err)
    }
  }
  ...
  async function takeScreenshot(): Promise<void> {
    ...
    try {
      ...
      console.error('[useEditorScreenshot] Failed to take screenshot:', err)
