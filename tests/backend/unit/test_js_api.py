...
@pytest.fixture
def api_with_tmp_path(tmp_path: Path):
...
@pytest.fixture
def api_with_file(tmp_path: Path, api_with_tmp_path):
...
class TestApiGetCode:
    ...
    def test_get_code_with_existing_file(self, api_with_file):
    ...
    def test_get_code_with_nonexistent_file(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_get_code_with_none_opened_file(self, api_with_tmp_path):
...
class TestApiSaveCode:
    ...
    def test_save_code_success(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_save_code_with_none_opened_file(self, api_with_tmp_path):
    ...
    def test_save_code_with_non_file_path(self, tmp_path: Path, api_with_tmp_path):
...
class TestApiConfig:
    ...
    def test_get_config_returns_merged(self, api_with_tmp_path):
    ...
    def test_set_config_simple_key(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_set_config_nested_key(self, tmp_path: Path, api_with_tmp_path):
...
class TestApiPathOperations:
    ...
    def test_path_ls(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_path_join(self, api_with_tmp_path):
    ...
    def test_path_parent(self, api_with_tmp_path):
        """Test path_parent returns parent directory."""
        result = api_with_tmp_path.path_parent("/home/user/file.txt")

        assert result == "/home/user"

    def test_path_get_info(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_path_get_info_raises_on_nonexistent(
        self, tmp_path: Path, api_with_tmp_path
    ):
    ...
    def test_path_get_text(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_path_get_text_raises_on_directory(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_path_to_uri(self, api_with_tmp_path):
    ...
    def test_path_to_uri_raises_on_relative(self, api_with_tmp_path):
    ...
    def test_path_touch(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_path_touch_existing_file(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_path_mkdir(self, tmp_path: Path, api_with_tmp_path):
...
class TestApiCompile:
    ...
    def test_compile_success(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_compile_unsupported_language(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_compile_error(self, tmp_path: Path, api_with_tmp_path):
...
class TestApiRunTask:
    ...
    def test_run_task_success(self, tmp_path: Path, api_with_tmp_path):
        ...
        with patch("pysrc.js_api.lang_runners", {"python": mock_runner}):
            with patch("pysrc.js_api.type_mp", {".py": {"id": "python"}}):
                with patch("pysrc.js_api.task_checker", return_value=True):
                    with patch.object(
                        api_with_tmp_path, "get_code", return_value={"type": "python"}
                    ):
                        with patch.object(
                            api_with_tmp_path,
                            "get_testcase",
    ...
    def test_run_task_unsupported_language(self, tmp_path: Path, api_with_tmp_path):
        ...
        with patch("pysrc.js_api.lang_runners", {}):
            with patch("pysrc.js_api.type_mp", {".xyz": {"id": "xyz"}}):
                with patch.object(
                    api_with_tmp_path, "get_code", return_value={"type": "xyz"}
                ):
...
class TestApiOtherMethods:
    ...
    def test_get_langs(self, api_with_tmp_path):
    ...
    def test_get_cpu_count(self, api_with_tmp_path):
    ...
    def test_get_disks(self, api_with_tmp_path):
    ...
    def test_get_config_path(self, tmp_path: Path, api_with_tmp_path):
...
class TestApiSetOpenedFile:
    ...
    def test_set_opened_file_success(self, tmp_path: Path, api_with_tmp_path):
        ...
        with patch.object(
            api_with_tmp_path.watcher, "create_observer", create=True
        ) as mock_observer:
...
class TestApiSetCwd:
    ...
    def test_set_cwd_success(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_set_cwd_raises_for_nonexistent(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_set_cwd_raises_for_file(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_get_cwd(self, tmp_path: Path, api_with_tmp_path):
...
class TestApiGetOpenedFile:
    ...
    def test_get_opened_file_returns_path(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_get_opened_file_returns_none(self, api_with_tmp_path):
...
class TestApiPinnedFiles:
    ...
    def test_get_pinned_files_empty(self, api_with_tmp_path):
        """Test get_pinned_files returns empty list when no pinned files."""
        result = api_with_tmp_path.get_pinned_files()

        assert result == []

    def test_add_pinned_file(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_remove_pinned_file(self, tmp_path: Path, api_with_tmp_path):
...
class TestApiScroll:
    ...
    def test_save_and_get_scroll(self, tmp_path: Path, api_with_tmp_path):
...
class TestApiTestcase:
    ...
    def test_get_testcase_empty(self, tmp_path: Path, api_with_tmp_path):
    ...
    def test_save_testcase(self, tmp_path: Path, api_with_tmp_path):
